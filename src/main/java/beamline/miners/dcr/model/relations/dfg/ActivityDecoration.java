...
public class ActivityDecoration {
	...
	public void addNewObservation(int currentIndex, boolean isFirstOccurrance) {
		...
		if (isFirstOccurrance) {
			...
			avgFirstOccurrence = avgFirstOccurrence
					+ ((currentIndex - avgFirstOccurrence) / observationsFirstOccurrance);
		}
	}
	...
	public boolean appearMostOnce() {
		return 1 == observations / observationsFirstOccurrance;
	}

	public double getTraceAppearances() {
		return observationsFirstOccurrance;
	}
